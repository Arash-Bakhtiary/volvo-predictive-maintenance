...
STATEMENTS = [
    ...
    # Volume for raw CSV uploads
    "CREATE VOLUME IF NOT EXISTS volvo_poc.bronze.raw_uploads COMMENT 'Landing zone for raw telemetry CSV files'",
]


def run_statement(client: WorkspaceClient, sql: str) -> bool:
